...
export const CategoryCircles: React.FC = () => {
  return (
    <section id="categories" className="py-16 sm:py-20 bg-gradient-to-br from-[#fdf0ea] via-[#faf5f0] to-[#f5edf8] border-b border-rose-100/60 relative overflow-hidden">
      <div className="absolute top-1/2 right-0 w-80 h-80 bg-purple-200/30 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-60 h-60 bg-rose-200/20 rounded-full blur-[100px] pointer-events-none" />
