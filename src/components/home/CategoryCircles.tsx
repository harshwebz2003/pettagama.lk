...
export const CategoryCircles: React.FC = () => {
  return (
    <section id="categories" className="py-20 bg-gradient-to-br from-purple-50 via-white to-rose-50 border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          ...
          <Link
            href="/shop"
            className="text-xs font-black text-royal-600 hover:text-royal-700 transition-colors flex items-center space-x-1 bg-white px-4 py-2.5 rounded-xl border border-slate-200 shadow-sm"
          >
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <span className="text-[10px] text-slate-400">{category.itemCount} items</span>
                </div>
              </Link>
            </motion.div>
          ))}
