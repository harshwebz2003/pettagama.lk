...
import { MapPin, Phone, Mail, Award, Heart, Sparkles, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="bg-slate-50 min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {/* Hero Card */}
        <div className="bg-royal-950 text-white rounded-3xl p-8 sm:p-14 relative overflow-hidden shadow-2xl border border-royal-800">
          <div className="max-w-2xl space-y-4 relative z-10">
            <div className="inline-flex items-center space-x-2 bg-royal-800 px-3.5 py-1 rounded-full text-amber-300 text-xs font-bold uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-6 space-y-4">
            <span className="text-xs font-bold text-royal-600 uppercase tracking-wider">The Pettagama.lk Journey</span>
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-sm">
                <span className="text-2xl font-black text-royal-800">10,000+</span>
                <span className="text-xs text-slate-500 block">Happy Crafters</span>
              </div>
              <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-sm">
                <span className="text-2xl font-black text-royal-800">1,000+</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-3">
            <div className="p-3 rounded-2xl bg-royal-50 text-royal-600 inline-block">
